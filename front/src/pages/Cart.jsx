  ...
  return(
    <div className='cart type'>
        <div className="sub_visual">
          ...
          <p className='heading_sub'>결제는 지점별로만 가능하며, 장바구니에 담긴 강좌는 최대 30일까지 보관 됩니다.</p>
        </div>

        <div className='min_inner'>
          <div className='cart_num'><span>목록</span><span className='num'>1개</span></div>
          <div class="utils_box">
            <Checkbox title='전체선택' id='all' name='all'/>
